...
<p>MayFly is a project designed and created by <a href="http://www.dratone.com">Jan-Jorre Laurens</a> when it became clear that there was a need to be able to send passwords in a secure manner.</p>
...
<p>Mayfly uses a public/private key encryption specification known as RSA.<br />
...
Because of this, the server doesn't know or store the decrypted password.</p>
...
<p>You can contact us by sending us an email to {{ Config::Get('system.contactemail') }}</p>
